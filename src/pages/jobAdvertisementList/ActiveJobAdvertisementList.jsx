          ...
          <Table.Body>
            {activeJobAdvertisements.map((activeJobAdvertisement) => (
              <Table.Row key={activeJobAdvertisement.id}>
                <Table.Cell>{activeJobAdvertisement.employer.companyName}</Table.Cell>
                <Table.Cell>{activeJobAdvertisement.employeePosition.positionName}</Table.Cell>
                <Table.Cell>{activeJobAdvertisement.numberOfOpenPosition}</Table.Cell>
                <Table.Cell>{activeJobAdvertisement.releaseDate}</Table.Cell>
                <Table.Cell>{activeJobAdvertisement.applicationDeadline}</Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
            ...
            <Table.Row>
              <Table.HeaderCell colSpan="6">
                <Segment floated="left">
                  ...
                  <span>{activeJobAdvertisements.length} Job advertisements listed.</span>
                </Segment>
